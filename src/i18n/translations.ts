export const pt = {
  ...
  services: {
    ...
    pricing: {
      label: 'Investimento',
      headline: 'Transparência antes de contratar.',
      note: '* Valores em R$. Projetos com escopo diferenciado são orçados sob medida após briefing.',
      cta: 'Falar sobre meu projeto',
      items: [
        { service: 'Landing Page', range: 'A partir de R$ 1.200' },
        { service: 'Site Institucional', range: 'A partir de R$ 3.500' },
        { service: 'Sistema Interno', range: 'A partir de R$ 8.000' },
        { service: 'IA Aplicada / Automação', range: 'A partir de R$ 5.000' },
        { service: 'E-commerce', range: 'A consultar' },
        { service: 'Projeto Personalizado', range: 'A consultar' },
      ],
    },
  },
  portfolio: {
  ...
  footer: {
    copy: '© 2025 Rodolfo Ferreira',
    tagline: 'Web Design · Sistemas · IA',
    social: {
      instagram: 'https://www.instagram.com/rodbomm/',
      whatsapp: 'https://wa.me/5511924796028?text=Ol%C3%A1%21%20Gostaria%20de%20conversar%20sobre%20um%20projeto.',
    },
  },
}
...
export const en: typeof pt = {
  ...
  services: {
    ...
    pricing: {
      label: 'Investment',
      headline: 'Transparency before you hire.',
      note: '* Values in BRL. Projects with custom scope are quoted individually after briefing.',
      cta: 'Talk about my project',
      items: [
        { service: 'Landing Page', range: 'Starting at R$ 1,200' },
        { service: 'Institutional Website', range: 'Starting at R$ 3,500' },
        { service: 'Internal System', range: 'Starting at R$ 8,000' },
        { service: 'Applied AI / Automation', range: 'Starting at R$ 5,000' },
        { service: 'E-commerce', range: 'On request' },
        { service: 'Custom Project', range: 'On request' },
      ],
    },
  },
  portfolio: {
